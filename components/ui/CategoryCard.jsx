...
export default function CategoryCard(props) {
    ...
    return (
        <Link  href={{ pathname: `/ApiSearch`, query: { category: props.category}}} className="w-70 h-30 flex items-end gap-2 p-1  border border-slate-300 cursor-pointer rounded-lg hover:bg-slate-100">
