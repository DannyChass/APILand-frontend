    ...
    return(
        <div className="overflow-hidden">
            ...
            <div className="flex pt-20 ">
                <div className="flex justify-center fixed  w-100 pl-25 ">
                <ul className="flex flex-col gap-5  px-5 py-5 w-full border-r-2 border-slate-200">
                    <li onClick={()=>setPageSetting('accountSetting')} className="listeSetting">Account Setting <FontAwesomeIcon icon={faGear}/></li>
                    <li onClick={() => setPageSetting('updateProfile')} className="listeSetting">Update Account <FontAwesomeIcon icon={faPencil}/></li>
                ...
                <div className="ml-[400px] pb-60  h-screen w-200 overflow-y-scroll">
                   {pageSetting=== 'accountSetting' && (<AccountSetting />)} 
                   {pageSetting === 'updateProfile' && (<UpdateProfile />)}
                </div>
            </div>
        </div>
    )
